...
describe(createEnrichmentTagsMatcher, () => {
  ...
  test("Not specifying a field results in the field unfrmOptEnrichmentTag being used.", () => {
    const rule: PersonalizationRule = { action: "boost", id: "rule1", pz: { crit: [] }, requiredValues: ["1_5", "2_3"] };
    const matcher = createEnrichmentTagsMatcher();
    const result = matcher(entry as Entry, rule);
  ...
  test("The order of the members of the required values does not matter.", () => {
    const rules: PersonalizationRule[] = [
      { action: "boost", id: "rule1", pz: { crit: [] }, requiredValues: ["1_5", "2_3"] },
      { action: "boost", id: "rule2", pz: { crit: [] }, requiredValues: ["2_3", "1_5"] },
    ];
    const matcher = createEnrichmentTagsMatcher("unfrmOptEnrichmentTag");
    rules.forEach(rule => {
      const result = matcher(entry as Entry, rule);
  ...
  test("All required values are required.", () => {
    const rules: PersonalizationRule[] = [
      { action: "boost", id: "rule1", pz: { crit: [] }, requiredValues: ["1_5", "2_3", "1_1"] },
      { action: "boost", id: "rule2", pz: { crit: [] }, requiredValues: ["1_1", "1_5", "2_3"] },
      { action: "boost", id: "rule3", pz: { crit: [] }, requiredValues: ["1_5", "1_1"] },
      { action: "boost", id: "rule4", pz: { crit: [] }, requiredValues: ["1_1", "2_3"] },
    ];
    const matcher = createEnrichmentTagsMatcher("unfrmOptEnrichmentTag");
    rules.forEach(rule => {
      const result = matcher(entry as Entry, rule);
  ...
  test("Rules with more than the required values match.", () => {
    const rules: PersonalizationRule[] = [
      { action: "boost", id: "rule1", pz: { crit: [] }, requiredValues: ["1_5"] },
      { action: "boost", id: "rule2", pz: { crit: [] }, requiredValues: ["2_3"] },
    ];
    const matcher = createEnrichmentTagsMatcher("unfrmOptEnrichmentTag");
    rules.forEach(rule => {
      const result = matcher(entry as Entry, rule);
